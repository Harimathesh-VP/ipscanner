...
Rich Data Visualization: View detailed reports, risk scores, and historical data.

AI-Powered Analysis: (Optional) Uses Google GenAI to summarize threat data.

History Management: Track your search history and export logs to JSON/CSV.

Secure Key Management: Configure and store your API keys locally within the browser context.
